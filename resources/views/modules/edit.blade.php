		...
		<div class="nav-align-top mb-4">
			...
			<div class="tab-content">
				...
				<div class="tab-pane fade show active" id="navs-pills-top-datibase" role="tabpanel">
					<div class="row mb-3">
						{{ Form::label('name', 'Nome', ['class'=>'col-sm-12 col-md-12 col-lg-2 col-xl-2 col-form-label']) }}
					...
					<div class="row mb-3">
						{{ Form::label('label', 'Alias', ['class'=>'col-sm-12 col-md-12 col-lg-2 col-xl-2 col-form-label']) }}
						<div id="divfieldnameID" class="col-sm-12 col-md-12 col-lg-9 col-xl-9">
					...
					<div class="row mb-3">
						{{ Form::label('label', 'Label', ['class'=>'col-sm-12 col-md-12 col-lg-2 col-xl-2 col-form-label']) }}
						<div id="divfieldnameID" class="col-sm-12 col-md-12 col-lg-9 col-xl-9">
					...
					<div class="row mb-3">
						{{ Form::label('code_menu', 'Codice Menu', ['class'=>'col-sm-12 col-md-12 col-lg-2 col-xl-2 col-form-label']) }}
						<div id="divfieldnameID" class="col-sm-12 col-md-12 col-lg-9 col-xl-9">
